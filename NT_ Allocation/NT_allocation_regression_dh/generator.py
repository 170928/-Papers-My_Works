...
if __name__ == "__main__":
    ...
    a = Generator(3,5,1,10)
    a.optimal(3, 5)
    a.getRandOptVal(1)
    for i in range(len(a.sumrateSet)):
        print(str(a.sumrateSet[i])+"\t",end="")
    print()
    for i in range(len(a.availableSet)):
        print(str(i+1)+str(a.availableSet[i])+"\t",end="")