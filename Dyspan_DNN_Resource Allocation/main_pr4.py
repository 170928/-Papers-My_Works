...
#==================================================
    ...
    parser.add_argument("--saveroot",default='./save/single-res/')
    parser.add_argument("--boardroot",default='./board/single_res/')
...
# 3. train
#==================================================
    #model = Model_dnn(User=args.num_user, Nt=args.num_nt, Comb=args.num_comb)
